...
# User Data
validUser = User("jenyakirakosyan27@gmail.com", "//eva[@tsaturyan]")
userWithInvalidUserName = User("wrongEmail", "//eva[@tsaturyan]")
userWithInvalidPassword = User("jenyakirakosyan27@gmail.com", "wrongPassword")
